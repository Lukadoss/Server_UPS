...
public:
    ...
    /**
     * Rozdělení příchozí zprávy od klienta do stringů.
     * @param msg zpráva
     * @return pole stringů
     */
    ...
    /**
     * Rozdělení příchozí zprávy od klienta do stringů. S parametrem delimeteru.
     * @param msg zpráva
     * @param delimiter rozdělovací znak
     * @return pole stringů
     */
